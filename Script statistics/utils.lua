...
function API.get_action_speed(action1, action2)
    local posDiff = math.abs(API.get_action_pos_diff(action1, action2))
    local posDur = API.get_action_duration(action1, action2)
...
function API.table_compare_no_order(table1, table2)
